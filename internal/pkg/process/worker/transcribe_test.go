...
func TestMapTransInput(t *testing.T) {
	d := newTestData()
	d.Words = append(d.Words, &process.ProcessedWord{TranscriptionWord: "olia", Tagged: process.TaggedWord{Word: "v1"},
...
func TestMapTransInput_RC(t *testing.T) {
	...
	d.Words = append(d.Words, &process.ProcessedWord{Tagged: process.TaggedWord{Word: "word"},
		AccentVariant: &process.AccentVariant{Accent: 103}})
	d.Words = append(d.Words, &process.ProcessedWord{Tagged: process.TaggedWord{Word: "word1"},
		AccentVariant: &process.AccentVariant{Accent: 103}})
	d.Words = append(d.Words, &process.ProcessedWord{Tagged: process.TaggedWord{Separator: ","}})
	d.Words = append(d.Words, &process.ProcessedWord{Tagged: process.TaggedWord{Word: "word2"},
		AccentVariant: &process.AccentVariant{Accent: 103}})
	inp, err := mapTransInput(d)
	assert.Nil(t, err)
...
func TestMapTransInput_UserAccent(t *testing.T) {
	d := newTestData()
	d.Words = append(d.Words, &process.ProcessedWord{TranscriptionWord: "olia",
		Tagged:        process.TaggedWord{Word: "v1"},
		AccentVariant: &process.AccentVariant{Accent: 103, Syll: "o-lia"},
		UserAccent:    101})
	d.Words = append(d.Words, &process.ProcessedWord{TranscriptionWord: "olia",
		Tagged:        process.TaggedWord{Word: "v1"},
...
func TestMapTransInput_User(t *testing.T) {
	d := newTestData()
	d.Words = append(d.Words, &process.ProcessedWord{TranscriptionWord: "olia", UserTranscription: "olia3",
		Tagged: process.TaggedWord{Word: "v1"},
	})
	inp, err := mapTransInput(d)
	assert.Nil(t, err)
